...
export interface Database {
  public: {
    Tables: {
      ...
      commercial_clients: {
        Row: { id: string; tenant_id: string; company_name: string; ruc: string | null; legal_rep: string | null; contact_email: string | null; contact_phone: string | null; admin_contact: string | null; status: string; created_at: string; updated_at: string };
        Insert: { id?: string; tenant_id: string; company_name: string; ruc?: string | null; legal_rep?: string | null; contact_email?: string | null; contact_phone?: string | null; admin_contact?: string | null; status?: string; created_at?: string; updated_at?: string };
        Update: { company_name?: string; ruc?: string | null; legal_rep?: string | null; contact_email?: string | null; contact_phone?: string | null; admin_contact?: string | null; status?: string; updated_at?: string };
      ...
      operative_paysheet: {
        Row: { id: string; tenant_id: string; user_id: string; shift_date: string; entry_type: string; hours: number; bonus: number; penalty: number; work_station_id: string | null; notes: string; created_at: string; updated_at: string };
        Insert: { id?: string; tenant_id: string; user_id: string; shift_date: string; entry_type?: string; hours?: number; bonus?: number; penalty?: number; work_station_id?: string | null; notes?: string; created_at?: string; updated_at?: string };
        Update: { entry_type?: string; hours?: number; bonus?: number; penalty?: number; work_station_id?: string | null; notes?: string; updated_at?: string };
        Relationships: [{ foreignKeyName: 'operative_paysheet_tenant_id_fkey'; columns: ['tenant_id']; isOneToOne: false; referencedRelation: 'tenants'; referencedColumns: ['id'] }, { foreignKeyName: 'operative_paysheet_work_station_id_fkey'; columns: ['work_station_id']; isOneToOne: false; referencedRelation: 'work_stations'; referencedColumns: ['id'] }];
      };
      report_sequences: {
      ...
      shift_alerts: {
        ...
        Update: { status?: string; resolved_by_shift_id?: string | null; resolved_at?: string | null };
        Relationships: [{ foreignKeyName: 'shift_alerts_tenant_id_fkey'; columns: ['tenant_id']; isOneToOne: false; referencedRelation: 'tenants'; referencedColumns: ['id'] }];
      };
    };
