...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  body { font-family: Helvetica, Arial, sans-serif; color: ${pdfColors.primary}; background: ${pdfColors.bg}; line-height: 1.55; font-size: 11px; }
  ...
  .title-block h1 { font-size: 15px; font-weight: 800; color: ${pdfColors.primary}; letter-spacing: 2px; text-transform: uppercase; margin-bottom: 3px; }
  .title-block .sub { font-size: 10px; color: ${pdfColors.secondary}; }
  ...
  .section-header { font-size: 9px; font-weight: 700; letter-spacing: 1.8px; color: ${pdfColors.accent}; text-transform: uppercase; padding-bottom: 6px; border-bottom: 1px solid ${pdfColors.borderLight}; margin-bottom: 10px; }

  /* Field rows */
  .field-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 6px 20px; }
  .field { display: flex; flex-direction: column; padding: 6px 0; }
  .field-label { font-size: 8px; font-weight: 600; color: ${pdfColors.muted}; letter-spacing: 0.8px; text-transform: uppercase; margin-bottom: 2px; }
  .field-value { font-size: 11px; font-weight: 600; color: ${pdfColors.primary}; }
  .field-full { grid-column: 1 / -1; }

  /* Table */
  table { width: 100%; border-collapse: collapse; margin-bottom: 12px; }
  thead th { font-size: 8px; font-weight: 700; letter-spacing: 1px; color: ${pdfColors.secondary}; text-transform: uppercase; text-align: left; padding: 8px 10px; border-bottom: 2px solid ${pdfColors.border}; }
  tbody td { padding: 8px 10px; font-size: 10.5px; border-bottom: 1px solid ${pdfColors.borderLight}; color: ${pdfColors.primary}; }
  ...
  /* Agreement box */
  .agreement { padding: 14px 16px; background: ${pdfColors.surface}; border: 1px solid ${pdfColors.border}; border-radius: 6px; font-size: 10px; color: ${pdfColors.secondary}; line-height: 1.7; margin-bottom: 20px; }
  ...
  .sig-line { border-top: 1px solid ${pdfColors.primary}; padding-top: 8px; font-size: 10px; font-weight: 700; color: ${pdfColors.primary}; }
  .sig-sub { font-size: 8px; color: ${pdfColors.muted}; margin-top: 2px; letter-spacing: 0.3px; }
  ...
  .event-header { font-size: 11px; font-weight: 700; color: ${pdfColors.primary}; margin-bottom: 3px; }
  .event-detail { font-size: 10px; color: ${pdfColors.secondary}; margin-bottom: 1px; }
  .event-narrative { font-size: 10px; color: ${pdfColors.primary}; margin: 5px 0; line-height: 1.6; }

  /* Empty state */
  .empty { font-size: 10px; color: ${pdfColors.muted}; font-style: italic; padding: 6px 12px; }

  /* List */
  ul { padding-left: 16px; }
  li { font-size: 10.5px; color: ${pdfColors.primary}; margin-bottom: 3px; }
  ...
  .footer-left { font-size: 8px; color: ${pdfColors.muted}; }
  .footer-right { font-size: 8px; color: ${pdfColors.accent}; font-weight: 600; letter-spacing: 0.3px; }
